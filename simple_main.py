"""
Simple Main GUI Application for Stock Chart Pattern Drawing Tool
...
from simple_chart_canvas import SimpleChartCanvas


class SimpleStockChartApp:
    """Simple main application class using tkinter Canvas."""
    
    def __init__(self, root):
        self.root = root
        self.root.title("Stock Chart Pattern Drawing Tool (Simple Version)")
        ...
        self.chart_canvas = SimpleChartCanvas(self.main_frame)
    ...
    def show_about(self):
        """Show about dialog."""
        about_text = """Stock Chart Pattern Drawing Tool v1.0 (Simple Version)

A Python desktop application for drawing and analyzing patterns on stock market charts.

Features:
• Load market data from CSV files
• Interactive chart visualization (tkinter-based)
• Freehand pattern drawing
• Export/import patterns as CSV
• Pattern persistence and accuracy

This simple version uses tkinter Canvas instead of matplotlib
for better compatibility with older macOS versions.
